    ...
    <div class="accordion w-100 objective-accordion" id="accordionExample">
        <div class="accordion-item">
            <h2 class="accordion-header position-relative" id="headingOne">
                ...
                <button class="alert-button position-absolute" v-if="game.getMalusLevel !== null" data-bs-toggle="modal"
                    data-bs-target="#modalMalus"><svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                        aria-label="Success:">
