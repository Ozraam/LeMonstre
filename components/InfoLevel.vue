...
<div class="accordion" id="accordionLevel">
    <div class="accordion-item">
        <h2 class="accordion-header" id="headingLevel">
            <button class="accordion-button d-xxl-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapseLevel" aria-expanded="true" aria-controls="collapseLevel">
                Niveau
            </button>
        ...
        <div id="collapseLevel" class="accordion-collapse collapse show accordion-level d-xxl-block " aria-labelledby="headingLevel" data-bs-parent="#accordionLevel" v-bs-collapse>
